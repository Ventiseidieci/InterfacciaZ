...
Grazie al visualizzatore installato con SuperSlicer, chiamato Gcode Viewer, è possibile visualizzare in anteprima il gcode generato, in modo da rendersi subito conto della coerenza dello slicing e del percorso del nozzle.
